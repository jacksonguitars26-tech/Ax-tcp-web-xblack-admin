...
<head>
    ...
    <style>
        ...
        .social-links { display: flex; gap: 10px; margin-bottom: 20px; justify-content: center; }
        .social-btn { flex: 1; padding: 10px; border-radius: 10px; text-decoration: none; color: white; font-size: 12px; font-weight: bold; text-align: center; transition: 0.3s; display: flex; align-items: center; justify-content: center; gap: 5px; }
        .social-btn:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(0,0,0,0.3); }
        .telegram-1 { background: linear-gradient(135deg, #0088cc, #00a8e6); }
        .telegram-2 { background: linear-gradient(135deg, #2aabee, #229ed9); }
...
<body>
    <div class="login-card">
        ...
        <div class="social-links">
            <a href="https://t.me/axemoteserver" target="_blank" class="social-btn telegram-1">📢 Join Telegram</a>
            <a href="https://t.me/axromjanyt" target="_blank" class="social-btn telegram-2">💬 Join 2d Telegram</a>
            <a href="https://www.youtube.com/@axromjan" target="_blank" class="social-btn youtube">▶️ Subscribe YouTube</a>
        </div>
